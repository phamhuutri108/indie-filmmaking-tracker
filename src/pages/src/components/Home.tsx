...
const BIO: Record<Lang, { p1: string; p2: string; p3: JSX.Element; p4: string; featuresTitle: string; feedbackTitle: string; feedbackSubtitle: string; namePlaceholder: string; emailPlaceholder: string; messagePlaceholder: string; submitLabel: string; successMsg: string; errorMsg: string }> = {
  vi: {
    ...
    <div style={{ padding: '48px 24px 80px', maxWidth: 820, margin: '0 auto' }}>
      ...
      <div style={{ display: 'flex', gap: 48, flexWrap: 'wrap', justifyContent: 'center', marginBottom: 72, alignItems: 'center' }}>
        ...
        <img
          ...
          alt="Tri Pham"
          style={{ width: 270, aspectRatio: '3/4', objectFit: 'cover', objectPosition: 'top', flexShrink: 0, borderRadius: 8 }}
        />
      </div>
